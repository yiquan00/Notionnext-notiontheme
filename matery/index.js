  ...
  return (
    <ThemeGlobalMatery.Provider value={{ searchModal }}>
      <div
        ...
        <main
          id='wrapper'
          className={`${siteConfig('MATERY_HOME_BANNER_ENABLE', null, CONFIG) ? '' : 'pt-8'} flex-1 w-full py-8 md:px-8 lg:px-24 relative`}>
          {/* 首页大图 */}
          {isHomePage && (
          ...
          {isHomePage && (
            <div className="w-full mt-4">
              <div className="dark:text-gray-200 mb-5 ml-4">
                <i className="mr-4 fas fa-tag" /> {BLOG.LOCALE?.COMMON?.TAGS ?? ''}
              </div>
  ...
  return (
    <>
      <div
        ...
        {/* 文章主体 */}
        <div
          className={`${fullWidth ? '' : '-mt-4'} transition-all duration-300 rounded-md mx-3 lg:border lg:rounded-xl lg:py-4 bg-white dark:bg-hexo-black-gray  dark:border-black`}>
              ...
              {post?.type && post?.type === 'Post' && (
                <>
                  <div data-wow-delay='.2s' className='wow fadeInUp px-10'>
                    ...
                    {/* <div id="" className="flex flex-col items-center justify-center my-4">
       <Link href={url} className=" mx-auto bg-blue-700 hover:bg-[#ea580c]  text-white font-bold py-2 px-4 rounded " rel="dofollow" target="_blank"> 
              点击访问
          </Link>
      </div>  */}
                  </div>
                  ...
                  <section
                    ...
                    {/* {post?.url && (
                      <div className="flex flex-col items-center justify-center my-4">
                        <Link href={post.url} className="mx-auto bg-blue-700 hover:bg-[#ea580c] text-white font-bold py-2 px-4 rounded" rel="nofollow" target="_blank">
                          点击访问
                        </Link>
                      </div>
                    )} */}
